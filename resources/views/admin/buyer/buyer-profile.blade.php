                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <div class="btn-group btn-group-sm">
                                    <a href="{{url('admin/buyer/form/'.$buyerprofile['id'])}}" class="btn btn-info"><i class="fas fa-edit"></i></a>
                                    @hasrole('admin')
                                    <a href="{{url('admin/buyer/delete/'.$buyerprofile['id'])}}" onclick="return confirm('Are you Sure to Delete this Buyer?')" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                                    @endhasrole
                                </div>
                            </ol>
                        </div>
                                ...
                                <form>
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <input type="hidden" id="buyerid" value="{{$buyerprofile['id']}}">
                                            <div class="col-md-3">
                                                <div class="form-group">
                            ...
                            <div class="card card-primary">
                                ...
                                <form>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group date" id="reservationdatetime"
                                                        data-target-input="nearest">
                                                        <input type="text" value="{{$buyerprofile['schedule']}}" class="form-control datetimepicker-input"
                                    ...
                                    <div class="card-footer">
                                        <input id="chkbtn" type="checkbox" @if($buyerprofile['status']==0)
                                        checked @endif data-toggle="switchbutton" data-onlabel="Available"
